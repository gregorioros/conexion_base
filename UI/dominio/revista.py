...
if __name__ == '__main__':
    revista78 = Revista(codigo='235', autor='JUAN', titulo='arte del sable', anio=2014, editorial='ISSU',
                        disponible=True, cantidad_disponible=75, tipo='DIGITAL')
    print(revista78)

    # PRUEBA DE SETTER DE TIPO
    revista78.tipo = 'DIGITAL'
    print(revista78)