...
if __name__ == '__main__':
    libro7 = Libro(codigo='19', autor='Jane Austen ', titulo='Orgullo y prejuicio', anio=2008,
                   editorial='Editorial Alma', disponible=True, cantidad_disponible=85, tipo_pasta='NORMAL')
    print(libro7)